...
//builder.Services.AddScoped<ICommands<Category>, ProjectEF.SQL_Infrastructure.Repository.CategoryCommands>();
#endregion
...
////registered CRUD Interface and its Implementaion in Infrastructure project
//builder.Services.AddScoped<ICommands<Category>, ProjectEF.postgreSQL_Infrastructure.Repository.CategoryCommands>();
#endregion
...
//registered CRUD Interface and its Implementaion in Infrastructure project
builder.Services.AddScoped<ICommands<Category>, ProjectEF.Mongo_Infrasturcture.Repository.CategoryCommands>();
